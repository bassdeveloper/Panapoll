<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Panapoll.login" %>
...
<head runat="server">
    ...
    <title>Panapoll - Sign In Page</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="form-signin">
                ...
                <input runat="server" type="text" id="inputUsername" class="form-control" placeholder="Username" required autofocus>
                <label for="inputPassword" class="sr-only">Password</label>
                <input runat="server" type="password" id="inputPassword" class="form-control" placeholder="Password" required>
                <asp:Button ID="userLogin" runat="server" Text="Sign In" class="btn btn-lg btn-primary btn-block" OnClick="userLogin_Click" />
            </div>
            <br />
            <br />
            <br />
