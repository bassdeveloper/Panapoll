<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edituserprofile.aspx.cs" Inherits="Panapoll.edituserprofile" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="form-signin">
                ...
                <input type="text" id="inputName" class="form-control" value="Sarang Kurani" autofocus>
                <br />
                <label for="inputUsername" class="">About Me</label>
                <input type="text" id="inputUsername" class="form-control" value="love for photography is like music">
                <br />
                ...
                <input type="number" id="inputage" class="form-control" value="20">
                <br />
                <label for="inputurl" class="">Portfolio Link</label>
                <input type="url" id="inputurl" class="form-control" value="https://www.facebook.com/sarang.kurani?fref=ts">
                <br />
                <br />
