<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hostpage.aspx.cs" Inherits="Panapoll.host" %>
...
<head>
    ...
    <title>Panapoll - Host Page</title>
                    ...
                    <div class="container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="hostpage">Home</a></li>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner" role="listbox" style="height:450px">
                <div class="item active">
                    <img class="first-slide" src="images/carousel_4.jpg" alt="First slide">
                    <div class="container">
                        <div class="carousel-caption">
                            <p><a class="btn btn-lg btn-primary" href="addcomp" role="button" style="width:250px; height:50px;">Add Competition</a>&nbsp&nbsp<a class="btn btn-lg btn-primary" href="prevcomp" role="button" style="width:250px; height:50px;">Previous Competition</a>&nbsp&nbsp<a class="btn btn-lg btn-primary" href="hostprofile" role="button" style="width:250px; height:50px;">Edit Profile</a></p>
                        </div>
                    </div>
                </div>
            </div>
