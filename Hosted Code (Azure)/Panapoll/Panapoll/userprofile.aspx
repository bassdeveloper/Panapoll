<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="Panapoll.userprofile" %>
...
<head runat="server">
    ...
    <title>Panapoll - User Profile</title>
    ...
    <form id="form1" runat="server">
                    ...
                    <div class="container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="livecomp">Live Competition</a></li>
        ...
        <div class="container">
            <div class="form-signin">
                ...
                <input type="text" id="inputName" class="form-control" value="Sarang Kurani" disabled>
                <br />
                <label for="inputUsername" class="">About Me</label>
                <input type="text" id="inputUsername" class="form-control" value="love for photography is like music" disabled>
                <br />
                <label for="inputEmail" class="">Email address</label>
                <input type="email" id="inputEmail" class="form-control" value="sarang.kurani@st.niituniversity.in" disabled>
                <br />
                <label for="inputPhoneNo" class="">Phone Number</label>
                <input type="number" id="inputPhoneNo" class="form-control" value="+918000786858" disabled>
                <br />
                ...
                <input type="number" id="inputage" class="form-control" value="20" disabled>
                <br />
                <label for="inputurl" class="">Portfolio Link</label>
                <input type="url" id="inputurl" class="form-control" value="https://www.facebook.com/sarang.kurani?fref=ts" disabled>
                <br />
                <br />
                <asp:Button ID="Button1" runat="server" class="btn btn-lg btn-primary btn-block" Text="Edit Profile" OnClick="Button1_Click" />
            </div>
            <br />
            <!-- FOOTER -->
            <footer>
