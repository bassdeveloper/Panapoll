<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="livecomp.aspx.cs" Inherits="Panapoll.livecomp" %>
...
<head runat="server">
    ...
    <title>Panapoll - Live Competition</title>
...
<body>
    <form id="form1" runat="server">
                    ...
                    <div class="container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="livecomp">Live Competition</a></li>
        ...
        <br />
        <div class="container">
            <asp:GridView ID="GridView1" CssClass="footable" HorizontalAlign="Center" runat="server" AutoGenerateColumns="false"
                Style="max-width: 500px">
                <Columns>
                    <asp:BoundField DataField="name" HeaderText="Owners Name" />
                    <asp:BoundField DataField="theme" HeaderText="Theme" />
                    <asp:BoundField DataField="prize" HeaderText="Prize" />
                    <asp:BoundField DataField="sub_dead" HeaderText="Submmision Deadline" />
                    <asp:BoundField DataField="res_dead" HeaderText="Result Deadline" />
                    ...
                    <asp:TemplateField HeaderText="Vote">
                        <ItemTemplate>
                            <asp:Button ID="Button2" runat="server" Text="Vote"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
