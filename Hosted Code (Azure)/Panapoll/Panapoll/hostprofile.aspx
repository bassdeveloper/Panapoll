<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hostprofile.aspx.cs" Inherits="Panapoll.hostprofile" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="form-signin">
                ...
                <input type="text" id="inputName" class="form-control" value="Vineet Patawari" disabled>
                <br />
                <label for="inputUsername" class="">Company Name(if any)</label>
                <input type="text" id="inputUsername" class="form-control" value="Panapoll" disabled>
                <br />
                <label for="inputcomp" class="">Comany Description(If Any)</label>
                <input type="text" id="inputcomp" class="form-control" value="Panapoll is a photography website" disabled>
                <br />
                ...
                <input type="number" id="inputPhoneNo" class="form-control" value="+919000987868" disabled>
                <br />
                ...
                <input type="number" id="inputage" class="form-control" value="21" disabled>
                <br />
                <label for="inputurl" class="">Company Link</label>
                <input type="url" id="inputurl" class="form-control" value="https://www.facebook.com/vineetp007" disabled>
                <br />
                <br />
