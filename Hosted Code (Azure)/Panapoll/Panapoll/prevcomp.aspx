<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="prevcomp.aspx.cs" Inherits="Panapoll.prevcomp" %>
...
<head runat="server">
    ...
    <title>Panapoll - Host View Competition</title>
                    ...
                    <div class="container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="prevcomp">View Competition</a></li>
            ...
            <asp:GridView ID="GridView1" CssClass="footable" HorizontalAlign="Center" runat="server" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="View">
                        <ItemTemplate>
                            <asp:Button ID="Button1"  runat="server" Text=" View Competition"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
